...
export const products: Product[] = [
  // Cakes
  {
    ...
    sizes: ['6 inch (serves 8)', '8 inch (serves 12)', '10 inch (serves 20)'],
  },
  {
    ...
    emoji: '🍫',
    flavors: ['Dark Chocolate', 'Milk Chocolate', 'Triple Chocolate'],
    sizes: ['6 inch (serves 8)', '8 inch (serves 12)', '10 inch (serves 20)'],
  },
  {
    id: 'red-velvet-cake',
  ...
  },
  {
    ...
    emoji: '💒',
    flavors: ['Vanilla', 'Chocolate', 'Red Velvet', 'Lemon', 'Strawberry', 'Almond'],
    sizes: ['2 tier (serves 30)', '3 tier (serves 50)', '4 tier (serves 75)'],
  },
  {
    ...
    emoji: '🎉',
    flavors: ['Funfetti', 'Chocolate', 'Vanilla', 'Strawberry'],
    sizes: ['6 inch (serves 8)', '8 inch (serves 12)', '10 inch (serves 20)'],
  },
  ...
  },
  {
    ...
    emoji: '🍫',
    flavors: ['Dark Chocolate', 'Milk Chocolate', 'Chocolate Mint'],
  },
  {
    ...
    emoji: '❤️',
    flavors: ['Red Velvet', 'Blue Velvet'],
  },
  {
    ...
    emoji: '✨',
    flavors: ['Salted Caramel', 'Cookies & Cream', 'Nutella', 'S\'mores', 'Lemon Raspberry'],
  },
  {
    id: 'mini-cupcakes',
    name: 'Mini Cupcakes',
  ...
  },
  {
    ...
    emoji: '✨',
    flavors: ['Vanilla', 'Chocolate', 'Red Velvet', 'Cookies & Cream', 'Strawberry'],
  },
  {
    id: 'themed-cake-pops',
  ...
  },
  {
    ...
    emoji: '💍',
    flavors: ['Champagne', 'Vanilla', 'Chocolate', 'Red Velvet'],
  },
]
